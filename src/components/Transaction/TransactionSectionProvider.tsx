...
import TransactionProviderItem from './TransactionProviderItem';

const TransactionSectionProvider: React.FC<TransactionSectionProps> = ( props ) => {
    return (
        <TransactionSectionBackground>
            ...
            renderItem={({ item }: any ) => <TransactionProviderItem {...item} primaryColor={props.primaryColor} secondColor={props.secondColor}/>}
            />
        </TransactionSectionBackground>
    );
};  

export default TransactionSectionProvider;